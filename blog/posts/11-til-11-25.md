# november '25
and a few goals for the new year | 12 min
...
<div style="display: flex; flex-direction: column; align-items: center; margin-top: 16px;">
  <strong>I vi ii<sub>/IV</sub> V7<sub>/IV</sub> IV V</strong> 
  <audio controls src="../../assets/audio/til/251 secondary_dom.mp3" style="margin-top: 8px;">
    Your browser does not support the audio element.
  </audio>
</div>

it feels like the musical equivalent of a tangent. a little branching path that leads back to the main story. very fun and cool.

### 2. shel silverstein adult abzs

it exists.

<img src="../../assets/abzs.png" width ="50%"/>

whenever I think of shel silverstein all I can see is that one picture of him he put on the back cover of "Where the Sidewalk Ends" where he has his foot prominently displayed in the center of the frame. he's also quoted as loving "to have a good time." we love shel. I won't put a photo of it here but I'm sure you can find it.

### 3. leap years don't happen every 4 years

although we probably won't live to see the next time a year divisible by 4 is skipped. it happens at the top of every century (unless the year is divisible by 400), so the next time will be the year 2100. if I'm still alive by then I will be very surprised.
...
I think this is so cool. basically it's a programming language for arranging music. if you're familiar with latex, strudl is to garage band (or logic or whatever) as latex is to microsoft word. I'm not sure how practical it is, but it's pretty fun to mess around in. here's a little [thing](https://strudel.cc/#CgpzZXRjcG0oNjApCgokOiBuKCJbMCAyIDQgNSA2IDcgNiA1IDQgMl0vNSIpCi5zY2FsZSgiPEU6cGhyeWdpYW4%%2BIikKLy8gLnNvdW5kKCJnbV9zeW50aF9iYXNzXzEiKQovLyAubHBmKDIwMCkKCgo%3D) I threw together as I was learning how to use it.<sup>4</sup>
